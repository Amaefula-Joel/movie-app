        ...
        <div className="grow-span-1">
            <div className="rounded-2xl rounded-br-none bg-[#e0e0e0] dark:bg-[#323232]">
                <div className="relative group">
                    <img src={`https://image.tmdb.org/t/p/w500/${poster_path}`} alt={title} className="w-full object-cover rounded-2xl aspect-[2/3]" />
                ...
                <div className="p-2 text-center text-black dark:text-white">
                    <h5 className='text-[16px] whitespace-nowrap overflow-hidden text-ellipsis max-w-[140px] mx-auto mb-2' title={title}> <Link to={`/details/${type}/${id}`} className='text-gray-900 dark:text-gray-100'> {title} </Link>  </h5>
